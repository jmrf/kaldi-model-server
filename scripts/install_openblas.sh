...
# This is a copy of the script found at:
# https://github.com/jmrf/kaldi/blob/pykaldi/tools/extras/install_openblas.sh
...
# Different prefix depending on the CPU Arch
# Full target lists can be found here:
# https://github.com/xianyi/OpenBLAS/blob/develop/TargetList.txt
cpu=$(uname -m)
if [ $cpu == armv/v7 ]; then
  make PREFIX=$(pwd)/OpenBLAS/install TARGET=ARMV7 USE_LOCKING=1 USE_THREAD=0 -C OpenBLAS all install
else
